...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      {/*
        No bottom padding needed on body — banner starts off-screen (translate-y-full)
        and slides in. Footer sits normally; banner floats above it when visible.
      */}
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={l.href}>
                    <Link href={l.href} className="text-on-surface-variant hover:text-primary transition-colors text-sm flex items-center gap-2">
